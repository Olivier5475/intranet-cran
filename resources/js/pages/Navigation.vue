...
<template>
    ...
    <div class="bg-white dark:bg-slate-900 p-2 rounded-xl shadow-sm border-gray-100 dark:border-zinc-800 flex items-center justify-between border">
        ...
        <div class="space-x-4 flex items-center">
            ...
            <CreationWidget v-if="canCreate" v-model="fastFolderCreation" :folder_id="folder_id" :is-active-fast-creation="fastFolderCreation" />
        </div>
    </div>
    ...
    <div v-show="view_mod == 'icon'" class="mt-6 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-4 grid grid-cols-2">
        ...
        <CreateFolderCardWidget v-if="fastFolderCreation && canCreate" :parent="parents.at(-1)" v-model="fastFolderCreation" :folder_id="folder_id" />
    </div>
